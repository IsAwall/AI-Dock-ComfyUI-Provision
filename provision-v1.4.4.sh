...
# AI-Dock ComfyUI Provisioning Script v1.4.4
# Updated with PyTorch 2.7.1, ALL dependencies fully pinned
# Prevents pip resolver from pulling incompatible versions
...
echo "========================================================================"
echo "AI-Dock ComfyUI Provisioning Script v1.4.4"
echo "========================================================================"
...
# ============================================================================
# PYTORCH 2.7.1 INSTALLATION (WITH --no-deps TO PREVENT RESOLVER CONFLICTS)
# ============================================================================
echo "Installing PyTorch 2.7.1 with CUDA 12.8 (--no-deps prevents version conflicts)..."
